...
- [ ] Cada modo avanzado tiene tutorial o entrada suficiente.
- [ ] Eventos quedan registrados para replay/validación.
- [ ] La UI mantiene legibilidad con efectos avanzados.
